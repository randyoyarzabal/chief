...
- **Local + CI compatible** - run `./tests/run-tests.sh`
...
- **Disconnected support** ready for environments without git connectivity

### For Developers

- Run `./tests/run-tests.sh` locally before pushing
